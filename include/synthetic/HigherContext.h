...
#ifndef _HIGHER_CONTEXT_H
#define _HIGHER_CONTEXT_H

#include <synthetic/SyntheticContext.h>

/**
 * Synthetic Context with more attributes than objects.
*/
class HigherContext: public SyntheticContext {
  private:
    int *optmap; // options map
  public:
    /*
     * Initialize Synthetic Context.
    */
    explicit HigherContext(int, int);
